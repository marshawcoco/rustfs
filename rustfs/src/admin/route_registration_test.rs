...
fn expected_admin_route_matrix() -> Vec<RouteMatrixEntry> {
    vec![
        ...
        table_route_sample(Method::GET, "/{warehouse}/catalog/capacity", "/analytics/catalog/capacity"),
        table_route_sample(Method::POST, "/{warehouse}/catalog/compact", "/analytics/catalog/compact"),
        ...
        compat_table_route_sample(Method::GET, "/{warehouse}/catalog/capacity", "/analytics/catalog/capacity"),
        compat_table_route_sample(Method::POST, "/{warehouse}/catalog/compact", "/analytics/catalog/compact"),
