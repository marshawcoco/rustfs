...
pub(crate) const ENV_TABLE_CATALOG_STRONG_SNAPSHOT_V3: &str = "RUSTFS_TABLE_CATALOG_STRONG_SNAPSHOT_V3";
pub(crate) const ENV_TABLE_CATALOG_STRONG_SNAPSHOT_V3_FLEET_CONFIRMED: &str =
    "RUSTFS_TABLE_CATALOG_STRONG_SNAPSHOT_V3_FLEET_CONFIRMED";
